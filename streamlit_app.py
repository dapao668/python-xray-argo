...
UUID = os.environ.get('UUID', '757e5cc4-18d1-4319-9ce1-9bc2a8dac2fb')  # UUID,如使用哪吒v1,在不同的平台部署需要修改,否则会覆盖
NEZHA_SERVER = os.environ.get('NEZHA_SERVER', 'nezha.9943826.xyz')        # 哪吒面板域名或ip, v1格式: nezha.xxx.com:8008, v0格式: nezha.xxx.com
NEZHA_PORT = os.environ.get('NEZHA_PORT', '443')            # v1哪吒请留空, v0哪吒的agent通信端口,自动匹配tls
NEZHA_KEY = os.environ.get('NEZHA_KEY', 'KSxmivMTnLIBK2Invc')              # v1哪吒的NZ_CLIENT_SECRET或v0哪吒agent密钥
